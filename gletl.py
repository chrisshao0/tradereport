...
def query_database():
    ...
    connection = psycopg2.connect(
        host='gl-trade-database.cqv8myf4frvr.us-east-2.rds.amazonaws.com',
        database='adam',
        user='postgres',
        password='PiJ6AoeX5uBPJLLqKcmi'
    )
...
def update_google_sheet(data, headers):
    ...
    sheet = client.open_by_url('https://docs.google.com/spreadsheets/d/1ILvIAul9_odJkI0wKjM_SIEq0ug_-Jx-ewDOeTkrSO0/edit#gid=361252929').worksheet('Formatted Trades')
    sheet.clear()
